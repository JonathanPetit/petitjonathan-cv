...
\skills{{Docker/1},{Git/3},{LATEX, SQL/5}, {GoLang, C/2}, {PhP, Javascript, HTML, CSS/3}, {Java, C\#, SWIFT/4}, {Python/6}}
...
\begin{twenty}
	\twentyitem{2008-2013}{CESS}{College Notre dame des Hayeffes, Mont-Saint-Guibert}{Etude secondaire, options mathématiques et siences}
	\twentyitem{2013-2018}{Bachelier}{ECAM, Bruxelles}{Option génie éléctrique (informatique, électronique)}
	\twentyitem{2018-...}{Master}{ECAM, Bruxelles}{Informatique}\\
\end{twenty}
...
\begin{twentyshort} 
	...
	\twentyitemshort{2018}{Participation au développement d'une Application mobile en Swift pour permettre à des personnes handicapées de réaliser des exercices vocals et visuels.} \\
	...
	\twentyitemshort{Depuis 2019}{Participation à un projet d'un drône de livraison. Responsable de la partie GPS et du pathfinding.}\\
...
\begin{twenty}
    \twentyitem{2013}{Cra-W, Unité de protection de l'eau et des sols.}{Job étudiant}{Multiples tests sur des échantillons de blés pur déterminer les caractéristiques des sols.}\\
    \twentyitem{Depuis 2019}{Denali, outdoor events}{Job étudiant}{Responsable d'équipe dans des événements extérieurs. Coordination et management durant les jours d'événements.}\\
...
\begin{twentyshort}
	\twentyitemshort{Français}{Langue natale}
...
\begin{twentyshort} 
	...
	\twentyitemshort{Scout}{Chef depuis 6 ans fonction de trésorier. Organisateur de plusieurs événement de plus de 500personnes.}
\end{twentyshort}
